...
* `SHORT`: Number of word-to-object maps
** `SHORT`: *Word* (not byte!) offset in chunk of word-to-object map
...
** `WORD`: Offset in chunk of null-terminated object name
...
* `BYTE[4]`: String pointer to alt-text (shift according to header)
