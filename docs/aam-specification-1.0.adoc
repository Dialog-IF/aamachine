...
[[CODE-type,CODE]]
*CODE*: byte address in <<CODE>> chunk
...
02	<<SET_CONT>>	<<CODE-type,CODE>>	{empty}
03	<<PROCEED>>	{empty}	{empty}
{empty}	{empty}	{empty}	{empty}

04	<<JMP>>	<<CODE-type,CODE>>	{empty}
05	<<JMP_MULTI>>	<<CODE-type,CODE>>	{empty}
85	<<JMPL_MULTI>>	<<CODE-type,CODE>>	{empty}
06	<<JMP_SIMPLE>>	<<CODE-type,CODE>>	{empty}
86	<<JMPL_SIMPLE>>	<<CODE-type,CODE>>	{empty}
07	<<JMP_TAIL>>	<<CODE-type,CODE>>	{empty}
87	<<TAIL>>	{empty}	{empty}
{empty}	{empty}	{empty}	{empty}
...
0a/8a	<<PUSH_CHOICE>>	<<BYTE>>/0 <<CODE-type,CODE>>	{empty}
0b/8b	<<POP_CHOICE>>	<<BYTE>>/0	{empty}
0c/8c	<<POP_PUSH_CHOICE>>	<<BYTE>>/0 <<CODE-type,CODE>>	{empty}
{empty}	{empty}	{empty}	{empty}
...
1c	<<STOP>>	{empty}	{empty}
1d	<<PUSH_STOP>>	<<CODE-type,CODE>>	{empty}
...
30/b0	<<IF_RAW_EQ>>	<<VWORD>>/0 <<RAW>> <<CODE-type,CODE>>	{empty}
31	<<IF_BOUND>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
32	<<IF_EMPTY>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
33	<<IF_NUM>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
34	<<IF_PAIR>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
35	<<IF_OBJ>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
36	<<IF_WORD>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
b6	<<IF_UWORD>>	<<VALUE>> <<CODE-type,CODE>>	≥ 0.4
37	<<IF_UNIFY>>	<<VALUE>> <<VALUE>> <<CODE-type,CODE>>	{empty}
38	<<IF_GT>>	<<VALUE>> <<VALUE>> <<CODE-type,CODE>>	{empty}
39/b9	<<IF_EQ>>	<<VWORD>>/<<VBYTE>> <<VALUE>> <<CODE-type,CODE>>	{empty}
3a/ba	<<IF_MEM_EQ>>	<<VALUE>>/0 <<INDEX>> <<RAW>> <<CODE-type,CODE>>	{empty}
3b/bb	<<IF_FLAG>>	<<VALUE>>/0 <<INDEX>> <<CODE-type,CODE>>	{empty}
3c	<<IF_CWL>>	<<CODE-type,CODE>>	{empty}
3d/bd	<<IF_MEM_EQ>>	<<VALUE>>/0 <<INDEX>> <<VBYTE>> <<CODE-type,CODE>>	≥ 0.4
{empty}	{empty}	{empty}	{empty}

40/c0	<<IFN_RAW_EQ>>	<<VWORD>>/0 <<RAW>> <<CODE-type,CODE>>	{empty}
41	<<IFN_BOUND>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
42	<<IFN_EMPTY>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
43	<<IFN_NUM>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
44	<<IFN_PAIR>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
45	<<IFN_OBJ>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
46	<<IFN_WORD>>	<<VALUE>> <<CODE-type,CODE>>	{empty}
c6	<<IFN_UWORD>>	<<VALUE>> <<CODE-type,CODE>>	≥ 0.4
47	<<IFN_UNIFY>>	<<VALUE>> <<VALUE>> <<CODE-type,CODE>>	{empty}
48	<<IFN_GT>>	<<VALUE>> <<VALUE>> <<CODE-type,CODE>>	{empty}
49/c9	<<IFN_EQ>>	<<VWORD>>/<<VBYTE>> <<VALUE>> <<CODE-type,CODE>>	{empty}
4a/ca	<<IFN_MEM_EQ>>	<<VALUE>>/0 <<INDEX>> <<RAW>> <<CODE-type,CODE>>	{empty}
4b/cb	<<IFN_FLAG>>	<<VALUE>>/0 <<INDEX>> <<CODE-type,CODE>>	{empty}
4c	<<IFN_CWL>>	<<CODE-type,CODE>>	{empty}
4d/cd	<<IFN_MEM_EQ>>	<<VALUE>>/0 <<INDEX>> <<VBYTE>> <<CODE-type,CODE>>	≥ 0.4
{empty}	{empty}	{empty}	{empty}
...
72	<<SAVE>>	<<CODE-type,CODE>>	{empty}
f2	<<SAVE_UNDO>>	<<CODE-type,CODE>>	{empty}
{empty}	{empty}	{empty}	{empty}
...
79/f9	<<CHECK_EQ>>	<<VWORD>>/<<VBYTE>> <<CODE-type,CODE>>	{empty}
7a/fa	<<CHECK_GT_EQ>>	<<VWORD>>/<<VBYTE>> <<CODE-type,CODE>> <<CODE-type,CODE>>	{empty}
7b/fb	<<CHECK_GT>>	<<RAW>>/<<BYTE>> <<CODE-type,CODE>>	{empty}
7c	<<CHECK_WORDMAP>>	<<INDEX>> <<CODE-type,CODE>>	{empty}
{empty}	{empty}	{empty}	{empty}

7d	<<CHECK_EQ_2>>	<<VWORD>> <<VWORD>> <<CODE-type,CODE>>	≥ 0.4
fd	<<CHECK_EQ_2>>	<<VBYTE>> <<VBYTE>> <<CODE-type,CODE>>	≥ 0.4
{empty}	{empty}	{empty}	{empty}
